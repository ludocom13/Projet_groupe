                            ...
                            <div class="p-4 p-md-5 flex-grow-1">
                                ...
                                <form action="{{route('R_regEvent')}}" method="POST">
                                    ...
                                    <div class="row g-2 mt-2">
                                        <div class="col-sm-6">
                                            <button class="btn btn-primary d-block w-100" type="submit" name="submit">Envoyer</button>
                                        </div>

                                        <div class="col-sm-6">
                                            <a class="btn btn-danger d-block w-100" href="{{route('R_connexion')}}">
                                                Connexion
                                            </a>
                                        </div>
