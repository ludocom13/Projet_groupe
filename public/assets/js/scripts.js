(function() {
   ...
   */
    ...
    */
    ...
    /**
    * Gestion d'affichage des modals
    */
    on('click', '.closer-modals', function(e) {
        const idModal = this.parentElement.id;
        this.parentElement.classList.add('d-none');
        this.parentElement.classList.remove('d-block');
    }, true);


    on('click', '.oppen-modals', function(e) {
        const idModal = this.getAttribute('data-id');
        select(idModal).classList.remove('d-none');
        select(idModal).classList.add('d-block');
    }, true);
